...
Tais eventos estão diretamente relacionados à SST, porém, existem dados em outros eventos que são utilizados para compor as informações exigidas pelos formulários substituídos.
...
As informações são obrigatórias só para segurados vinculados ao Regime Geral de Previdência Social - RGPS, mas é possível a informação relativa a servidores vinculados a RPPS, para fins de cumprimento do que dispõe a Nota Técnica 2/2014/CGNAL/DRPSP/SPPS/MPS.

A categoria de um trabalhador, segundo a Tabela 1 do eSocial, refere-se ao tipo de vínculo empregatício que o profissional possui com o empregador. Essa classificação é fundamental para o registro correto das informações no sistema eSocial, especialmente no momento da admissão do trabalhador.

Resumo da obrigatoriedade de envio das informações de SST, por categoria de trabalhador, Tabela 01:
...
Obrigatório, em relação a servidores vinculados ao RGPS. Facultativo em relação
