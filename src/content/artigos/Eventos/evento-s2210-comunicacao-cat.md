...
O evento **S-2210** é utilizado no eSocial para comunicar oficialmente a ocorrência de um **acidente de trabalho**, uma **doença ocupacional** ou um **acidente de trajeto**. Essa comunicação é compulsória e deve ser efetuada mesmo nos casos em que o incidente não resulte em afastamento do trabalhador de suas atividades laborais.
...
## 2. Prazos Legais e Consequências Jurídicas
...
## 3. Direitos Assegurados ao Trabalhador
...
## 4. Estrutura Técnica e Tabelas do eSocial Relacionadas
